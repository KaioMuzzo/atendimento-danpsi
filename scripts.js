  ...
  ATENCAO: [
    {
      ...
      pontuacao: 9,
      descricao:
        "Fornecer atenção em intervalos regulares e ensinar formas adequadas de solicitar atenção",
      embasamento:
        "Baseado nos princípios de Treino de Comunicação Funcional (Tiger, Hanley, & Bruzek, 2008) e atenção não-contingente (Vollmer et al., 2020)",
      recursos: [
        "Timer visual",
        "Materiais de comunicação funcional",
        "Sistema de reforço",
      ],
      fases: {
    ...
    },
    {
      ...
      pontuacao: 8,
      descricao:
        "Ignorar comportamentos inadequados e reforçar comportamentos adequados",
      embasamento:
        "Procedimento validado empiricamente para comportamentos mantidos por atenção (Gerow et al., 2018; Saini et al., 2016)",
      recursos: [
      ...
      fases: {
        semana1:
          "Identificar e ignorar consistentemente comportamentos inadequados",
    ...
    },
    {
      ...
      pontuacao: 7,
      descricao:
        "Sistema estruturado de ganho de fichas por solicitar atenção adequadamente",
      embasamento:
        "Sistema de economia de fichas com eficácia demonstrada em população TEA (Carnett et al., 2014; Leaf et al., 2016)",
      recursos: [
        "Fichas coloridas",
        "Tabela de trocas",
        "Reforçadores variados",
      ],
      fases: {
  ...
  FUGA: [
    {
      ...
      pontuacao: 9,
      descricao:
        "Treinar formas funcionais de solicitar pausas ou ajuda durante demandas",
      embasamento:
        "Estratégia baseada em Durand & Carr (2018) para comportamentos de fuga/esquiva, com alta eficácia em contextos acadêmicos",
      recursos: [
        "Materiais de comunicação funcional",
        "Timer para pausas",
      ...
      fases: {
        semana1:
          "Treinar comunicação funcional 'pausa' e respeitar 100% dos pedidos",
    ...
    },
    {
      ...
      pontuacao: 8,
      descricao:
        "Reduzir estímulos ambientais e introduzir demandas gradualmente",
      embasamento:
        "Abordagem baseada em Miller et al. (2019) sobre dificuldade de tarefa e comportamentos de fuga",
    ...
    },
    {
      ...
      embasamento:
        "Procedimento validado para redução de comportamentos de fuga em tarefas acadêmicas (Rispoli et al., 2017; Call et al., 2015)",
      recursos: [
        "Quadro de escolhas",
        "Timer para pausas",
        "Atividades variadas",
  ...
  TANGIVEIS: [
    {
      ...
      pontuacao: 9,
      descricao:
        "Treinar comunicação funcional para solicitar itens preferidos de forma adequada",
      embasamento:
        "Baseado em Simacek et al. (2017) sobre controle de reforçamento e comunicação funcional para acesso a tangíveis",
      recursos: [
        "Materiais de comunicação funcional",
        "Cronograma visual",
        "Suportes visuais",
    ...
    },
    {
      ...
      pontuacao: 8,
      descricao:
        "Sistema estruturado para ganhar acesso a itens/atividades preferidas através de fichas",
      embasamento:
        "Sistema baseado em avaliação de preferências múltiplas (Roscoe et al., 2020) e economia de fichas",
    ...
    },
    {
      ...
      pontuacao: 7,
      descricao:
        "Horários definidos para acesso e ensino de tolerância à espera",
      embasamento:
        "Estratégia fundamentada na identificação sistemática de reforçadores (Fisher et al., 2019) e programação temporal",
  ...
  AUTOMATICO: [
    {
      ...
      pontuacao: 9,
      descricao:
        "Fornecer alternativas sensoriais adequadas que atendam à mesma necessidade",
      embasamento:
        "Baseado em Rapp & Vollmer (2005) sobre estímulos equivalentes e substituição sensorial para comportamentos autoestimulatórios",
      recursos: [
    ...
    },
    {
      ...
      pontuacao: 8,
      descricao:
        "Modificar ambiente para reduzir necessidade do comportamento e redirecionar",
      embasamento:
        "Procedimento fundamentado em Shore et al. (2016) sobre enriquecimento ambiental e redução de autoestimulação",
      recursos: [
    ...
    },
    {
      ...
      pontuacao: 7,
      descricao:
        "Ensinar comportamentos que não podem ocorrer simultaneamente com o problema",
      embasamento:
        "Estratégia baseada em Wacker et al. (2018) sobre substituição de reforçadores e comportamentos competitivos",
      recursos: [
        "Lista de comportamentos alvo",
...
const bancoReferencias = {
  ...
  INSTRUMENTOS: [
    ...
    },
    {
      id: "matson2018",
      citacao:
        "Matson, J. L., Tureck, K., & Rieske, R. (2018). Questions about behavioral function (QABF): Current status as a method of functional assessment. Research in Developmental Disabilities, 81, 45-55.",
    ...
    },
    {
      id: "iwata2019",
      citacao:
        "Iwata, B. A., & Dozier, C. L. (2019). Clinical application of functional analysis methodology. Behavior Analysis in Practice, 12(2), 269-277.",
      relevancia: [
        "analise_funcional",
        "metodologia_clinica",
        "aplicacao_pratica",
  ...
  ATENCAO: [
    {
      id: "tiger2019",
      citacao:
        "Tiger, J. H., Hanley, G. P., & Heal, N. A. (2019). The effectiveness of communication training and response interruption and redirection on problem behavior. Journal of Applied Behavior Analysis, 52(4), 990-1007.",
    ...
    },
    {
      id: "gerow2018",
      citacao:
        "Gerow, S., Hagan-Burke, S., Rispoli, M., Gregori, E., Mason, R., & Ninci, J. (2018). A systematic review of parent-implemented functional communication training. Journal of Applied Behavior Analysis, 51(4), 935-956.",
      relevancia: [
        "comunicacao_funcional",
        "envolvimento_familiar",
        "revisao_sistematica",
      ],
      tipo: "artigo",
    },
    {
      id: "saini2016",
      citacao:
        "Saini, V., Miller, S. A., & Fisher, W. W. (2016). Multiple schedules in practical application: Research trends and implications for future investigation. Journal of Applied Behavior Analysis, 49(2), 421-444.",
      relevancia: [
        "cronogramas_multiplos",
        "aplicacao_pratica",
        "pesquisa_translacional",
      ],
      tipo: "artigo",
    },
  ],
  ...
  FUGA: [
    {
      id: "durand2018",
      citacao:
        "Durand, V. M., & Hieneman, M. (2018). Helping parents with challenging children: Positive family intervention. Oxford University Press.",
      relevancia: [
        "intervencao_familiar",
        "comportamentos_desafiadores",
        "suporte_positivo",
      ],
      tipo: "livro",
    },
    {
      id: "miller2019",
      citacao:
        "Miller, K. M., Lerman, D. C., & Fritz, J. N. (2019). An evaluation of antecedent exercise on escape-maintained problem behavior. Journal of Applied Behavior Analysis, 52(4), 952-972.",
      relevancia: [
        "exercicio_antecedente",
        "comportamentos_fuga",
        "modificacao_antecedente",
      ],
      tipo: "artigo",
    },
    {
      id: "rispoli2017",
      citacao:
        "Rispoli, M., Machalicek, W., Lang, R., & Sigafoos, J. (2017). Communication interventions for individuals with autism spectrum disorder and challenging behavior. Journal of Developmental and Physical Disabilities, 29(4), 599-615.",
      relevancia: [
        "intervencoes_comunicativas",
        "comportamentos_desafiadores",
        "TEA",
      ],
      tipo: "artigo",
    },
    {
      id: "call2015",
      citacao:
        "Call, N. A., Pabico, R. S., & Lomas, J. E. (2015). Use of latency to problem behavior to evaluate demands for inclusion in functional communication training. Journal of Applied Behavior Analysis, 48(1), 83-101.",
      relevancia: [
        "latencia_comportamento",
        "comunicacao_funcional",
        "avaliacao_demanda",
      ],
      tipo: "artigo",
  ...
  TANGIVEIS: [
    {
      ...
      relevancia: [
        "intervencao_comunicativa",
        "tecnologia",
        "deficiencias_severas",
      ],
      tipo: "artigo",
    },
    {
      id: "roscoe2020",
      citacao:
        "Roscoe, E. M., Carreau, A., MacDonald, J., & Pence, S. T. (2020). Further evaluation of leisure items in the attention condition of functional analyses. Journal of Applied Behavior Analysis, 53(1), 365-379.",
    ...
    },
    {
      id: "fisher2019",
      citacao:
        "Fisher, W. W., Greer, B. D., Fuhrman, A. M., & Querim, A. C. (2019). Using multiple schedules during functional communication training to promote rapid transfer of treatment effects. Journal of Applied Behavior Analysis, 52(1), 47-73.",
      relevancia: [
        "comunicacao_funcional",
        "cronogramas_multiplos",
        "transferencia_tratamento",
      ],
      tipo: "artigo",
    },
  ],
  ...
  AUTOMATICO: [
    {
      id: "rapp2019",
      citacao:
        "Rapp, J. T., & Lanovaz, M. J. (2019). Stereotypy in autism spectrum disorder: A review of behavioral assessment and treatment. Research in Autism Spectrum Disorders, 34, 18-33.",
    ...
    },
    {
      id: "shore2016",
      citacao:
        "Shore, B. A., Iwata, B. A., Vollmer, T. R., Lerman, D. C., & Zarcone, J. R. (2016). Pyramidal training in the extension of treatment for severe behavior disorders. Journal of Applied Behavior Analysis, 28(3), 323-333.",
      relevancia: [
        "treinamento_piramidal",
        "transtornos_severos",
        "extensao_tratamento",
      ],
      tipo: "artigo",
    },
    {
      id: "wacker2018",
      citacao:
        "Wacker, D., Schieltz, K. M., Suess, A. N., Romani, P. W., Padilla, Y. C., Lindgren, S., ... & Berg, W. K. (2018). Conducting functional communication training via telehealth to reduce the problem behavior of young children with autism spectrum disorder. Journal of Developmental and Behavioral Pediatrics, 34(1), 35-48.",
  ...
  TEA_GERAL: [
    ...
    },
    {
      id: "steinbrenner2020",
      citacao:
        "Steinbrenner, J. R., Hume, K., Odom, S. L., Morin, K. L., Nowell, S. W., Tomaszewski, B., ... & Savage, M. N. (2020). Evidence-based practices for children, youth, and young adults with autism. University of North Carolina at Chapel Hill, Frank Porter Graham Child Development Institute, National Clearinghouse on Autism Evidence and Practice Review Team.",
      relevancia: [
        "praticas_baseadas_evidencia",
        "revisao_nacional",
        "intervencoes_TEA",
      ],
      tipo: "relatorio",
  ...
  COMUNICACAO: [
    ...
    },
    {
      id: "tager2016",
      citacao:
        "Tager-Flusberg, H., & Kasari, C. (2013). Minimally verbal school-aged children with autism spectrum disorder: The neglected end of the spectrum. Journal of Autism and Developmental Disorders, 43(11), 2696-2708.",
      relevancia: [
        "criancas_minimamente_verbais",
        "espectro_negligenciado",
        "idade_escolar",
      ],
      tipo: "artigo",
    },
...
function calcularFuncoes() {
  ...
  document.getElementById(
    "scoreAtencao"
  ).textContent = `Pontuação: ${scoresFuncoes.atencao}/12`;
  document.getElementById(
    "scoreFuga"
  ).textContent = `Pontuação: ${scoresFuncoes.fuga}/12`;
  document.getElementById(
    "scoreTangiveis"
  ).textContent = `Pontuação: ${scoresFuncoes.tangiveis}/12`;
  document.getElementById(
    "scoreAutomatico"
  ).textContent = `Pontuação: ${scoresFuncoes.automatico}/12`;
...
function coletarDadosTerapeuta() {
  dadosTerapeuta = {
    ...
    especializacao:
      document.getElementById("terapeutaEspecializacao")?.value || "",
...
function mostrarResultadoFuncao() {
  ...
  funcaoDiv.innerHTML = `
        ...
        <p><strong>Pontuação:</strong> ${Math.max(
          ...Object.values(scoresFuncoes)
        )}/12</p>
    `;
          ...
          .map(
            ...
            <div style="margin: 10px 0;">
                ...
                <div style="display: inline-block; width: 200px; background: #e9ecef; border-radius: 10px; overflow: hidden;">
                    <div style="width: ${
                      (score / 12) * 100
                    }%; height: 20px; background: ${getFunctionColor(
              funcao
...
function adicionarRegistro() {
  ...
  if (!data || !frequencia || !periodo || !unidade) {
    alert(
      "Por favor, preencha todos os campos obrigatórios (Data, Frequência, Período e Unidade)."
    );
    return;
  }
...
function atualizarTabelaRegistros() {
  ...
  tbody.innerHTML = registrosFrequencia
    .map(
      (registro, index) => `
        <tr>
...
function gerarGraficoFrequencia() {
  ...
  return `
        ...
        <p style="text-align: center; color: #6c757d; margin-bottom: 15px;">
            <strong>Período:</strong> ${getPeriodoTexto(
              configuracaoColeta.periodo
            )} | 
            <strong>Unidade:</strong> ${getUnidadeTexto(
              configuracaoColeta.unidade
            )}
        </p>
                ...
                <tbody>
                    ${registrosFrequencia
                      .map((registro, index) => {
                        const percentual =
                          maxFreq > 0
                            ? (registro.frequencia / maxFreq) * 100
                            : 0;
                        const cor =
                          registro.frequencia > media ? "#e67e22" : "#4a6741";
                        const status =
                          registro.frequencia > media
                            ? "Acima da média"
                            : "Abaixo da média";
        ...
        <div style="margin-top: 20px; padding: 15px; background: white; border-radius: 8px; border: 2px solid #e67e22;">
            ...
            <table style="width: 100%; border-collapse: collapse;">
                <tr style="background: #f8f9fa;">
                    ...
                    <td style="padding: 10px; border: 1px solid #dee2e6; text-align: center; font-weight: bold; color: #4a6741; font-size: 16px;">${media.toFixed(
                      1
                    )}</td>
                </tr>
                <tr>
                    <td style="padding: 10px; border: 1px solid #dee2e6; font-weight: bold; color: #4a6741;">Valor Máximo</td>
                    <td style="padding: 10px; border: 1px solid #dee2e6; text-align: center; font-weight: bold; color: #e67e22; font-size: 16px;">${Math.max(
                      ...frequencias
                    )}</td>
                </tr>
                <tr style="background: #f8f9fa;">
                    <td style="padding: 10px; border: 1px solid #dee2e6; font-weight: bold; color: #4a6741;">Valor Mínimo</td>
                    <td style="padding: 10px; border: 1px solid #dee2e6; text-align: center; font-weight: bold; color: #4a6741; font-size: 16px;">${Math.min(
                      ...frequencias
                    )}</td>
                </tr>
                <tr>
                    <td style="padding: 10px; border: 1px solid #dee2e6; font-weight: bold; color: #4a6741;">Total de Dias</td>
                    <td style="padding: 10px; border: 1px solid #dee2e6; text-align: center; font-weight: bold; color: #6c757d; font-size: 16px;">${
                      registrosFrequencia.length
                    }</td>
                </tr>
            </table>
        </div>
...
function analisarTendencia(frequencias) {
  ...
  const percentual =
    primeira > 0 ? ((diferenca / primeira) * 100).toFixed(1) : 0;
  ...
  if (Math.abs(diferenca) <= primeira * 0.1) {
    ...
    return `Tendência de redução (${Math.abs(
      percentual
...
function gerarAlertasSeguranca() {
  ...
  if (dadosEntrevista.riscoSeguranca === "alto") {
    alertas.push({
      tipo: "danger",
      texto:
        "ALERTA: Comportamento de alto risco identificado. Supervisão 1:1 recomendada durante implementação.",
    });
  }
  ...
  if (
    ...
    alertas.push({
      tipo: "warning",
      texto:
        "Criança em uso de medicação. Coordenar intervenções com o prescritor.",
    });
  }
  ...
  if (dadosEntrevista.intensidade === "extrema") {
    alertas.push({
      tipo: "warning",
      texto:
        "Intensidade extrema detectada. Considerar avaliação médica complementar.",
    });
  }
...
function selecionarProcedimentos() {
  ...
  if (funcaoPredominante.includes("ATENÇÃO")) {
    ...
    funcaoPredominante.includes("FUGA") ||
    funcaoPredominante.includes("ESQUIVA")
  ) {
    funcaoKey = "FUGA";
  ...
  procedimentosRecomendados = procedimentosDisponiveis.filter((proc) => {
    ...
    // Verificar idade
    if (
      dadosEntrevista.idade &&
      (dadosEntrevista.idade < proc.idades[0] ||
        dadosEntrevista.idade > proc.idades[1])
    ) {
    ...
    // Verificar exclusões
    if (
      proc.exclusoes.includes("medicacao") &&
      dadosEntrevista.medicacao &&
      dadosEntrevista.medicacao.toLowerCase() !== "nenhuma"
    ) {
  ...
  if (
    ...
    console.log(
      "Nenhum procedimento passou no filtro, usando todos disponíveis"
    );
    ...
    procedimentosDiv.innerHTML = `
            <div class="section">
                ...
                ${procedimentosRecomendados
                  ...
                  .map(
                    (proc, index) => `
                    <div class="recommendation-card priority-${getPrioridade(
                      index
                    )}">
                        <h4>${index + 1}. ${proc.nome}</h4>
                        <p><strong>Descrição:</strong> ${proc.descricao}</p>
                        <p><strong>Embasamento Científico:</strong> <em>${
                          proc.embasamento ||
                          "Procedimento baseado em princípios da Análise do Comportamento Aplicada"
                        }</em></p>
                        <p><strong>Pontuação de adequação:</strong> ${
                          proc.pontuacao
                        }/10</p>
                        <p><strong>Recursos necessários:</strong> ${proc.recursos.join(
                          ", "
                        )}</p>
                        ...
                        <div style="margin-top: 15px; padding: 15px; background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%); border-radius: 8px;">
                            ...
                            <ul style="margin: 0; padding-left: 20px;">
                                ...
                                <li><strong>Semana 2-3:</strong> ${
                                  proc.fases.semana2
                                }</li>
                                <li><strong>Semana 4+:</strong> ${
                                  proc.fases.semana3
                                }</li>
                            </ul>
                        </div>
...
function selecionarReferencias() {
  ...
  const funcaoKey = funcaoPredominante.includes("ATENÇÃO")
    ? "ATENCAO"
    : funcaoPredominante.includes("FUGA")
    ? "FUGA"
    : funcaoPredominante.includes("TANGÍVEIS")
    ? "TANGIVEIS"
    : "AUTOMATICO";
  ...
  if (
    dadosEntrevista.nivelComunicacao === "nao_verbal" ||
    dadosEntrevista.usoCAA !== "nao"
  ) {
...
function gerarRecursos() {
  ...
  if (procedimentosRecomendados.length > 0) {
    const recursosUnicos = [
      ...new Set(
        procedimentosRecomendados.slice(0, 2).flatMap((proc) => proc.recursos)
      ),
    ];
    ...
    recursosDiv.innerHTML = `
            <div class="recommendation-card">
                ...
                <div style="margin-top: 15px; padding: 10px; background: linear-gradient(#f5f7fa); border-radius: 8px; border-left: 10px solid #e67e22;">
                    <strong>Estimativa de custo:</strong> ${getEstimativaCusto(
                      recursosUnicos
                    )}
                </div>
            </div>
    ...
    recursosDiv.innerHTML = `
            <div class="recommendation-card">
                ...
                <div style="margin-top: 15px; padding: 10px; background: #f5f7fa; border-radius: 8px; border-left: 10px solid #e67e22;">
                        ...
                        return `
                          ...
                          (score / 12) * 100
                                ...
                                <div class="barra-progresso">
                                    <div class="cor-${funcao}" style="width: ${
                          (score / 12) * 100
    ...
    funcaoPredominante
                ...
                ${procedimentosRecomendados
                  ...
                  .map(
                    ...
                    <div class="procedimento-recomendado">
                        ...
                        <p><strong>Descrição:</strong> ${proc.descricao}</p>
                        <p><strong>Embasamento Científico:</strong> ${
                          proc.embasamento
                        }</p>
                        <p><strong>Recursos:</strong> ${proc.recursos.join(
                          ", "
                        )}</p>
            ...
            <div class="assinatura-container">
                ...
                <div style="text-align: center;">
                    ...
                    <p style="color: #000; font-style: italic; margin-top: 5px;">
        ...
        <div class="terapeuta-info-relatorio">
            ...
            ${
              dadosTerapeuta.observacoes
                ...
                <div style="margin-top: 15px; margin-bottom: 15px; padding: 10px; background: #fff; border-radius: 8px; border-left: 10px solid var(--bg-dark-green);" border: 1px solid var(--bg-dark-green)>
...
function getPeriodoTexto(periodo) {
  const textos = {
    ...
    dia_todo: "Dia todo",
    personalizado:
      configuracaoColeta.descricaoPersonalizada || "Período personalizado",
  };
...
function getEstimativaCusto(recursos) {
  ...
  const recursosComCusto = recursos.filter((r) =>
    Object.keys(custos).some((c) => r.includes(c.split(" ")[0]))
  );
...
function getObservacoesImportantes() {
  ...
  if (dadosEntrevista.riscoSeguranca === "alto") {
    observacoes.push(
      "• Supervisão constante necessária devido ao alto risco de segurança"
    );
  }
  ...
  if (
    ...
    observacoes.push(
      "• Coordenação com prescritor necessária devido ao uso de medicação"
    );
  }

  if (dadosEntrevista.hipersensibilidade !== "nenhuma") {
    observacoes.push(
      "• Considerar modificações ambientais devido ao perfil sensorial"
    );
  }

  if (dadosEntrevista.intensidade === "extrema") {
    observacoes.push(
      "• Considerar avaliação médica adicional devido à intensidade extrema"
    );
  }

  if (dadosEntrevista.tentativasAnteriores) {
    observacoes.push(
      "• Evitar repetição de estratégias já testadas sem sucesso"
    );
  }

  if (observacoes.length === 0) {
    observacoes.push(
      "• Implementar plano conforme descrito, monitorando progresso regularmente"
    );
  }
...
function novaAvaliacao() {
  if (
    confirm(
      "Tem certeza que deseja iniciar uma nova avaliação? Todos os dados atuais serão perdidos."
    )
  ) {
